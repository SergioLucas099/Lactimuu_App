...
public class Buscar_Producto_Model implements Serializable {

    private String Descripcion, img_url, Nombre, Estado, Tipo, Estado_Clima, documentId;
    private int Precio;

    public Buscar_Producto_Model() {
    }

    public Buscar_Producto_Model(String Descripcion, String img_url, String Nombre, int Precio, String Estado, String Tipo, String Estado_Clima) {
